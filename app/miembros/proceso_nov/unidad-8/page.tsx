...
export default function Unidad8NovicioPage() {
  ...
  const guardarAvanceParcial = async (preguntasCompletadas: number) => {
    ...
    if (error) {
      console.error("Error guardando avance parcial de NOV U8:", error);
      return false;
    }
  ...
  const guardarProgresoCuestionario = async () => {
    ...
    if (error) {
      console.error("Error guardando progreso de NOV U8:", error);
      setErrorGuardado(
  ...
  useEffect(() => {
    const cargarProgreso = async () => {
      ...
      if (error) {
        console.error("Error cargando progreso de NOV U8:", error);
      }
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 8: Evolución del sistema bancario en Guatemala
      </h1>
        ...
        {completado && (
          ...
          >
            ...
            <p style={{ lineHeight: 1.8 }}>
              ...
              La Unidad 8 ha quedado registrada como finalizada y puede continuar
