...
import { TEORIA, QUESTIONS } from "@/content/proceso_nov/unidad7";
...
export default function Unidad7NovicioPage() {
  ...
  const guardarAvanceParcial = async (preguntasCompletadas: number) => {
    ...
    if (error) {
      console.error("Error guardando avance parcial de NOV U7:", error);
      return false;
    }
  ...
  const guardarProgresoCuestionario = async () => {
    ...
    if (error) {
      console.error("Error guardando progreso de NOV U7:", error);
      setErrorGuardado(
  ...
  useEffect(() => {
    const cargarProgreso = async () => {
      ...
      if (error) {
        console.error("Error cargando progreso de NOV U7:", error);
      }
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:nov:unidad-7:${codigo}`;
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 7: La reforma de 1924 y el nacimiento del quetzal
      </h1>
        ...
        {completado && !modoRepaso && (
          ...
          >
            ...
            <p style={{ lineHeight: 1.8 }}>
              ...
              La Unidad 7 ha quedado registrada como finalizada y puede continuar
