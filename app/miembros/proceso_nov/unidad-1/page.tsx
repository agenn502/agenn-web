        ...
        <>
          ...
          >
            <p style={{ marginTop: 0, lineHeight: 1.8 }}>
              Este módulo explora los sistemas económicos desarrollados en el territorio de Guatemala antes de la llegada de los españoles en 1524, cuando aún no existía moneda acuñada. También analiza cómo el valor surgía de factores como la utilidad, la rareza, el significado simbólico y el control social, utilizando bienes como el cacao, la obsidiana o el jade como medios de intercambio..
            </p>
