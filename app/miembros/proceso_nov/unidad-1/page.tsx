...
import { TEORIA, QUESTIONS } from "@/content/proceso_nov/unidad1";
...
export default function Unidad1NovicioPage() {
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:nov:unidad-1:${codigo}`;
