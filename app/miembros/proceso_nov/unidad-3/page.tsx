...
import { TEORIA, QUESTIONS } from "@/content/proceso_nov/unidad3";
...
export default function Unidad3NovicioPage() {
  ...
  const guardarAvanceParcial = async (preguntasCompletadas: number) => {
    ...
    if (error) {
      console.error("Error guardando avance parcial de NOV U3:", error);
      return false;
    }
  ...
  const guardarProgresoCuestionario = async () => {
    ...
    if (error) {
      console.error("Error guardando progreso de NOV U3:", error);
      setErrorGuardado(
  ...
  useEffect(() => {
    const cargarProgreso = async () => {
      ...
      if (error) {
        console.error("Error cargando progreso de NOV U3:", error);
      }
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:nov:unidad-3:${codigo}`;
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 3: La Casa de Moneda de Guatemala y la acuñación colonial
      </h1>
        ...
        {completado && !modoRepaso && (
          ...
          >
            ...
            <p style={{ lineHeight: 1.8 }}>
              ...
              La Unidad 3 ha quedado registrada como finalizada y puede continuar
