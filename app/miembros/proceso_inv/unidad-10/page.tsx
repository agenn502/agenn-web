...
import { TEORIA, QUESTIONS } from "@/content/proceso_inv/unidad10";
...
export default function Unidad10InvestigadorPage() {
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:inv:unidad-10:${codigo}`;
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 10: Diseño de una propuesta de investigación propia
      </h1>
            ...
            {unidadCompletada ? (
              ...
              <>
                ...
                <p style={{ lineHeight: 1.8 }}>
                  ...
                  propuestos. La Unidad 10 se considerará completada cuando el
                  Consejo Académico apruebe el trabajo escrito.
                </p>

                <Link
                  href="/miembros/proceso_inv/unidad-10/ensayo"
                  style={{
                    display: "inline-block",
                    marginTop: "0.5rem",
                    background: "#6b6f1a",
