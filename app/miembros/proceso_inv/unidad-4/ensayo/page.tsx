...
const REGLA_UNIDAD = obtenerReglaTrabajoInv("unidad-4")!;
const TEMAS_UNIDAD = TEMAS_TRABAJOS_INV["unidad-4"] || [];
...
export default function TrabajoUnidad4Page() {
  ...
  const generarCodigoVerificacion = () => {
    ...
    return `AGENN-INV-U4-${miembro?.codigo || "USER"}-${random}`;
  };
  ...
  const subirImagen = async () => {
    ...
    const nombreArchivo =
      `unidad-4/${miembro.codigo}-u4.jpg`;
  ...
  const guardarTrabajo = async (enviarRevision = false) => {
    ...
    if (
      enviarRevision &&
      !confirm(
        "¿Está seguro de que desea enviar la nota de investigación al Consejo Académico? Mientras esté en revisión no podrá editarla."
      )
    ) {
      return;
    }
    ...
    try {
      ...
      const slug =
        slugTrabajo ||
        `${generarSlug(titulo)}-${miembro.codigo.toLowerCase()}-u4`;
      ...
      if (enviarRevision) {
        ...
        alert(
          "Nota de investigación enviado al Consejo Académico para revisión."
        );
  ...
  if (unidadCompletada || aprobadoAcademicamente) {
    return (
      <div style={{ maxWidth: "900px" }}>
        <h1>Nota de investigación de la Unidad 4</h1>
        ...
        >
          ...
          >
            ...
            La Unidad 4 ha sido completada y puede continuar
  ...
  return (
    <div style={{ maxWidth: "900px" }}>
      ...
      >
        <strong>
          Puede desarrollar su nota de investigación en varias sesiones.
        </strong>
        <br />
        Utilice <strong>Guardar borrador</strong> para
        conservar su avance y regresar posteriormente.
        Seleccione{" "}
        <strong>Enviar nota de investigación a revisión</strong>{" "}
      ...
      <p style={{ lineHeight: 1.8 }}>
        ...
        basada en uno de los temas propuestos y someterla a revisión
      ...
      >
        <label>
        <strong>Tema de la nota de investigación *</strong>
        </label>
        ...
        <label>
          <strong>Título de la nota de investigación *</strong>
        </label>
        ...
        <label>
          <strong>Contenido de la nota de investigación *</strong>
        </label>
        ...
        <textarea
          ...
          placeholder="Redacte aquí su nota de investigación..."
          rows={18}
          style={{
            width: "100%",
            padding: "1rem",
        ...
        {puedeEditar && (
          ...
          >
            ...
            >
              Enviar nota de investigación a revisión
            </button>
          </div>
        )}
