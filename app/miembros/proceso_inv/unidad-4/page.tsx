...
import { TEORIA, QUESTIONS } from "@/content/proceso_inv/unidad4";
...
export default function Unidad4InvestigadorPage() {
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:inv:unidad-4:${codigo}`;
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 4: Identificación, clasificación y catalogación numismática
      </h1>
            ...
            {unidadCompletada ? (
              ...
              <>
                ...
                <p style={{ lineHeight: 1.8 }}>
                  ...
                  elaborar una nota de investigación basada en uno de los temas
                  propuestos. La Unidad 4 se considerará completada cuando el
                  Consejo Académico apruebe el trabajo escrito.
                </p>

                <Link
                  href="/miembros/proceso_inv/unidad-4/ensayo"
                  style={{
                    display: "inline-block",
                    marginTop: "0.5rem",
                    background: "#6b6f1a",
                ...
                >
                  Continuar a la nota de investigación
                </Link>
