...
import { TEORIA, QUESTIONS } from "@/content/proceso_inv/unidad5";
...
export default function Unidad5InvestigadorPage() {
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:inv:unidad-5:${codigo}`;
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 5: Reconstrucción de sistemas monetarios mediante evidencia
      </h1>
            ...
            {unidadCompletada ? (
              ...
              <>
                ...
                <p style={{ lineHeight: 1.8 }}>
                  ...
                  propuestos. La Unidad 5 se considerará completada cuando el
                  Consejo Académico apruebe el trabajo escrito.
                </p>

                <Link
                  href="/miembros/proceso_inv/unidad-5/ensayo"
                  style={{
                    display: "inline-block",
                    marginTop: "0.5rem",
                    background: "#6b6f1a",
