...
import { TEORIA, QUESTIONS } from "@/content/proceso_inv/unidad6";
...
export default function Unidad6InvestigadorPage() {
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:inv:unidad-6:${codigo}`;
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 6: La exonumia como campo de investigación histórica
      </h1>
            ...
            {unidadCompletada ? (
              ...
              <>
                ...
                <p style={{ lineHeight: 1.8 }}>
                  ...
                  propuestos. La Unidad 6 se considerará completada cuando el
                  Consejo Académico apruebe el trabajo escrito.
                </p>

                <Link
                  href="/miembros/proceso_inv/unidad-6/ensayo"
                  style={{
                    display: "inline-block",
                    marginTop: "0.5rem",
                    background: "#6b6f1a",
