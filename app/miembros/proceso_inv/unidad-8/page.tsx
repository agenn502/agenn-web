...
import { TEORIA, QUESTIONS } from "@/content/proceso_inv/unidad8";
...
export default function Unidad8InvestigadorPage() {
  ...
  useEffect(() => {
    ...
    const claveMemoria = `agenn:lectura:inv:unidad-8:${codigo}`;
  ...
  return (
    <div style={{ maxWidth: "980px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>
        Unidad 8: De la evidencia a la inferencia y la explicación
      </h1>
            ...
            {unidadCompletada ? (
              ...
              <>
                ...
                <p style={{ lineHeight: 1.8 }}>
                  ...
                  propuestos. La Unidad 8 se considerará completada cuando el
                  Consejo Académico apruebe el trabajo escrito.
                </p>

                <Link
                  href="/miembros/proceso_inv/unidad-8/ensayo"
                  style={{
                    display: "inline-block",
                    marginTop: "0.5rem",
                    background: "#6b6f1a",
