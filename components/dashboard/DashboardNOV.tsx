...
export default function DashboardNOV() {
  ...
  return (
    <div style={{ maxWidth: "900px" }}>
      ...
      <p style={{ lineHeight: 1.8 }}>
        <strong>{user.nombre}</strong>, continúa avanzando en su proceso de
        Formación y Acreditación Académica dentro de la AGENN.
      </p>
      ...
      >
        ...
        >
          <span>Progreso general del Nivel Novicio</span>
        ...
        >
          El Nivel Novicio desarrolla progresivamente el estudio de la
          historia monetaria de Guatemala, la numismática y la notafilia.
          Cada unidad completada le acerca a su acreditación como Académico
          Novicio.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <p style={{ lineHeight: 1.7 }}>
            Consulte las unidades disponibles, el avance de cada una y continúe
            desde el punto en que dejó su formación.
          </p>
        ...
        >
          ...
          <p style={{ lineHeight: 1.7 }}>
            Consulte su trayectoria académica, las acreditaciones existentes y
            los requisitos correspondientes a las etapas posteriores.
          </p>
