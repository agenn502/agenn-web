export const TEORIA = [
  {
    titulo: "1. Introducción: el billete como documento institucional",
    bloques: [{ tipo: "texto", contenido: `
Para comprender el papel moneda guatemalteco no basta con observar denominación, imágenes o estado de conservación. Es necesario identificar **quién emitió el billete, bajo qué autorización y dentro de qué sistema bancario**.

La historia notafílica de Guatemala permite observar varias etapas: un primer banco nacional de corta duración; bancos privados autorizados para emitir; intervenciones extraordinarias en períodos de crisis; la Caja Reguladora; el Banco Central de Guatemala, S. A.; y finalmente el Banco de Guatemala.

Por ello, un billete es simultáneamente **medio de pago, documento institucional y fuente histórica**. Su emisor no es un dato secundario: es una de las claves para clasificarlo e interpretarlo (Molina Calderón, 2008; Pérez Irungaray, 2025).
` }],
  },
  {
    titulo: "2. Banco Nacional de Guatemala: primer experimento bancario, 1874–1876",
    bloques: [{ tipo: "texto", contenido: `
El **Banco Nacional de Guatemala** inició operaciones el **23 de marzo de 1874** y entró en liquidación el **24 de noviembre de 1876**. Molina Calderón señala que operó solamente **32 meses** y que se perdió totalmente su capital inicial.

Sus billetes constituyen las primeras emisiones bancarias guatemaltecas documentadas en esta etapa. La bibliografía notafílica registra denominaciones de 1, 5, 10, 20, 50 y 100 pesos impresas por la **Compañía Columbiana de Billetes de Banco, Washington D. C.** (Molina Calderón, 2008; Pérez Irungaray, 2025; Quisquinay Rojas, 2022).

Este caso enseña que **primer banco emisor ≠ institución bancaria consolidada**. La banca guatemalteca comenzó mediante experimentación institucional.
` }],
  },
  {
    titulo: "3. Siete bancos privados de emisión: 1877–1926",
    bloques: [{ tipo: "texto", contenido: `
Después de la liquidación del Banco Nacional comenzó una etapa ininterrumpida de bancos privados autorizados mediante concesión gubernamental, todavía sin una legislación bancaria general. Molina Calderón identifica **siete bancos privados de emisión**:

- Banco Internacional de Guatemala, S. A. (1877)
- Banco Colombiano, S. A. (1878)
- Banco de Occidente, S. A. (1881)
- Banco Comercial de Guatemala, S. A. (1891)
- Banco Agrícola Hipotecario, S. A. (1893)
- Banco de Guatemala, S. A. (1895)
- Banco Americano de Guatemala, S. A. (1895)

Sus billetes eran diferentes, pero utilizaban una **unidad monetaria común**. Por ello, esta etapa no debe explicarse como si cada banco hubiera creado su propia moneda o unidad de cuenta (Molina Calderón, 2008).

Para el notafílico, **misma denominación ≠ mismo billete**: el emisor, diseño, fecha, impresor, firmas, series y otras características pueden cambiar completamente la clasificación.
` }],
  },
  {
    titulo: "4. 1897: curso forzoso y Decreto 527",
    bloques: [{ tipo: "texto", contenido: `
En **1897**, durante el gobierno de José María Reina Barrios, el Decreto 527 amplió la facultad de emisión de los bancos privados y estableció que sus billetes serían de **curso forzoso en los pagos y transacciones públicas y privadas**, considerándolos legalmente como moneda metálica efectiva.

El contexto fue complejo: el Estado atravesaba dificultades fiscales y los bancos privados tenían capacidad para adquirir plata y financiar al gobierno. La documentación muestra, por tanto, una estrecha relación entre **emisión bancaria, necesidades fiscales y política monetaria** (Banco de Guatemala, 2024).

Es importante distinguir:

**curso forzoso → obligación jurídica de aceptación**  
**confianza → percepción económica y social sobre el valor**

Una norma puede imponer aceptación sin garantizar por sí sola estabilidad o confianza.
` }],
  },
  {
    titulo: "5. 1898: el Comité Bancario no fue simplemente “otro banco”",
    bloques: [{ tipo: "texto", contenido: `
En **1898**, ya bajo Manuel Estrada Cabrera, el Decreto 589 dio origen al **Comité Bancario** a partir de acuerdos entre la Secretaría de Hacienda y los bancos privados. La fuente del Banco de Guatemala lo sitúa dentro de la crisis monetaria y de la relación financiera entre el Estado y las instituciones bancarias.

Por ello, es más riguroso estudiarlo como un **mecanismo extraordinario de emisión y coordinación en contexto de crisis**, no como si hubiera sido un banco comercial ordinario comparable con el Banco Internacional o el Banco de Occidente (Banco de Guatemala, 2024).

Para el estudiante, la denominación de la institución no basta: debe preguntarse **qué naturaleza jurídica tenía y por qué emitía**.
` }],
  },
  {
    titulo: "6. El desorden monetario: no fue simplemente “demasiados bancos”",
    bloques: [{ tipo: "texto", contenido: `
La multiplicidad de emisores produjo una extraordinaria diversidad notafílica, pero el problema monetario de finales del siglo XIX y comienzos del XX no debe atribuirse mecánicamente a que existieran varios bancos.

Intervinieron también la situación fiscal del Estado, los préstamos de los bancos al gobierno, el curso forzoso, la emisión de papel moneda, la depreciación cambiaria y la ausencia inicial de una legislación bancaria general.

Por ello, el estudiante debe evitar una explicación demasiado simple:

**varios emisores ≠ automáticamente crisis.**

La crisis debe reconstruirse mediante las relaciones entre emisión, reservas, legislación, Estado, bancos y confianza monetaria (Banco de Guatemala, 2024; Molina Calderón, 2008).
` }],
  },
  {
    titulo: "7. La Caja Reguladora: estabilización antes de la centralización",
    bloques: [{ tipo: "texto", contenido: `
Como se estudió en la unidad anterior, la **Caja Reguladora** fue creada en **1923** y constituye un antecedente inmediato de la reforma monetaria y bancaria. Su función principal fue contribuir a estabilizar el cambio y ordenar el proceso de conversión.

La Caja no debe confundirse con un banco central completo. Fue una institución transitoria dentro de un proceso que culminaría en una nueva estructura legal y bancaria.

Para la notafilia, las intervenciones y registros asociados con la Caja son especialmente importantes porque una marca añadida puede documentar **una segunda etapa institucional en la vida de un billete**.
` }],
  },
  {
    titulo: "8. 1926: primera reforma bancaria integral",
    bloques: [{ tipo: "texto", contenido: `
Molina Calderón caracteriza la reorganización de **1926** como la primera reforma bancaria total de Guatemala. Además de establecer un banco central, se promulgó una legislación general para las instituciones de crédito y se introdujeron nuevas reglas de reservas e inspección.

El cambio decisivo fue pasar de bancos privados con facultad de emisión a un sistema en el que la emisión quedaba centralizada.

Esto no significa que desaparecieran los bancos comerciales. Significa que **banco comercial y banco emisor dejaron de ser funciones equivalentes**.
` }],
  },
  {
    titulo: "9. Banco Central de Guatemala, S. A.: capital mixto y emisión exclusiva",
    bloques: [{ tipo: "texto", contenido: `
El **Banco Central de Guatemala, Sociedad Anónima**, fue constituido en 1926 con **capital mixto del Estado y de particulares**. Molina Calderón lo identifica como único emisor de billetes y monedas dentro del nuevo sistema.

*Un quetzal, una moneda, un siglo* sitúa el **1 de julio de 1926** como fecha oficial de inicio de operaciones. Sin embargo, los primeros billetes del quetzal emitidos por esta institución aparecen posteriormente: Q1 en 1927, Q5 en 1927, Q20 en 1927, Q2 en 1928 y Q10 en 1929 (Banco de Guatemala, 2024).

De nuevo aparece una regla metodológica ya aprendida:

**fecha de inicio de una institución ≠ fecha de cada una de sus emisiones.**
` }],
  },
  {
    titulo: "10. Los primeros billetes del quetzal y los “chemas”",
    bloques: [{ tipo: "texto", contenido: `
Los primeros billetes del quetzal emitidos por el Banco Central fueron impresos por firmas inglesas como **Thomas de la Rue & Co., Ltd.** y **Waterlow and Sons**. En su anverso aparece el busto del general José María Orellana y son conocidos en el ámbito numismático como **“chemas”** (Banco de Guatemala, 2024).

La fuente también documenta ejemplares de **100 quetzales que no llegaron a ponerse en circulación**. Este dato permite introducir otra distinción:

**billete producido o espécimen conocido ≠ billete efectivamente emitido para circulación.**

La notafilia estudia también pruebas, especímenes y emisiones frustradas, pero deben clasificarse con precisión.
` }],
  },
  {
    titulo: "11. La Gran Depresión: una prueba para la primera reforma",
    bloques: [{ tipo: "texto", contenido: `
La Gran Depresión iniciada en 1929 afectó profundamente al sistema bancario guatemalteco. Molina Calderón señala que, entre los seis bancos privados de emisión que operaban en aquella etapa, **el Banco de Occidente fue el que logró atravesar la crisis**, mientras otras instituciones cerraron o no consiguieron adaptarse al nuevo marco.

La crisis demuestra que centralizar la emisión podía corregir problemas institucionales, pero **no inmunizaba a la economía frente a crisis internacionales, problemas de crédito o debilidades bancarias**.
` }],
  },
  {
    titulo: "12. 1945–1946: segunda reforma bancaria",
    bloques: [{ tipo: "texto", contenido: `
Después de la Revolución de Octubre de 1944 se desarrolló una segunda reforma bancaria. Molina Calderón identifica tres grandes cuerpos legales en 1945–1946: **Ley Monetaria, Ley Orgánica del Banco de Guatemala y Ley de Bancos**.

La Ley Orgánica otorgó al nuevo Banco de Guatemala el privilegio exclusivo de emisión, la administración de las reservas monetarias internacionales y funciones de dirección y vigilancia del sistema bancario. A diferencia del Banco Central de 1926, el nuevo banco contaba con **capital aportado por el Estado** y una estructura vinculada a la Junta Monetaria (Molina Calderón, 2008).

Por tanto:

**Banco Central de Guatemala, S. A. (1926) ≠ Banco de Guatemala (1946).**
` }],
  },
  {
    titulo: "13. 1946–1948: una transición notafílica extraordinaria",
    bloques: [{ tipo: "texto", contenido: `
El Banco de Guatemala inició operaciones el **1 de julio de 1946**, después del traspaso de activos y pasivos procedentes del Banco Central. Pero sus primeros billetes propios fueron autorizados en **1948**.

Durante la transición utilizó papel moneda del extinto Banco Central en denominaciones de **50 centavos, 1, 5 y 20 quetzales**, intervenido con la denominación **“BANCO DE GUATEMALA”**. Los primeros billetes propios del nuevo banco fueron autorizados el **15 de septiembre de 1948** (Pérez Irungaray, 2025).

Esta transición es especialmente formativa porque demuestra que:

**cambio institucional ≠ sustitución instantánea de todo el papel moneda.**

Un billete anterior puede adquirir un nuevo contexto institucional mediante una intervención posterior.
` }],
  },
  {
    titulo: "14. Método de análisis notafílico institucional",
    bloques: [{ tipo: "tabla", columnas: ["Elemento", "Pregunta que debe formularse"], filas: [
      ["Emisor", "¿Banco Nacional, banco privado, Comité Bancario, Banco Central o Banco de Guatemala?"],
      ["Fecha", "¿Corresponde con el período real de funcionamiento del emisor?"],
      ["Denominación", "¿Peso, centavos de quetzal o quetzales?"],
      ["Casa impresora", "¿Quién produjo físicamente el billete?"],
      ["Intervenciones", "¿Tiene sello, registro, contramarca u otra modificación posterior?"],
      ["Estatus", "¿Circuló, es espécimen, prueba o emisión no puesta en circulación?"],
      ["Sistema bancario", "¿Emisión privada, transición reguladora o emisión centralizada?"],
      ["Contexto legal", "¿Qué norma o reforma explica su emisión?"],
    ]}],
  },
  {
    titulo: "15. Conclusión: de la pluralidad de emisores a la banca central",
    bloques: [{ tipo: "texto", contenido: `
La historia bancaria guatemalteca no fue una marcha lineal desde el desorden hacia la perfección. Fue una sucesión de experimentos, concesiones, crisis y reformas.

El Banco Nacional de 1874 fue un experimento breve; desde 1877 se consolidó una etapa de bancos privados de emisión; el curso forzoso de 1897 y el Comité Bancario de 1898 muestran la estrecha relación entre banca y Estado; la Caja Reguladora preparó la estabilización; el Banco Central de 1926 centralizó la emisión; y la reforma de 1945–1946 creó el Banco de Guatemala bajo una estructura distinta.

Para el notafílico, la enseñanza principal es sencilla pero exigente: **identificar el valor de un billete no basta. Hay que reconstruir su emisor, régimen jurídico, fecha, impresor, intervención y condición de circulación.**
` }],
  },
  {
    titulo: "Referencias de la unidad 8",
    bloques: [{ tipo: "texto", contenido: `
...
- Lara Grojec, L. R. (2021). Historia de la banca en Guatemala. *Visión Financiera*, 41, 4–7.
