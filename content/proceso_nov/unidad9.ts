export const TEORIA = [
  {
    titulo: "1. Del papel moneda al objeto notafílico",
    bloques: [{ tipo: "texto", contenido: `
En la unidad anterior se estudió **quién emitía** y cómo evolucionó institucionalmente el sistema bancario guatemalteco. En esta unidad el centro de atención cambia: interesa comprender **qué información contiene el billete como objeto histórico y cómo debe analizarse**.

La notafilia estudia sistemáticamente los billetes y otros documentos de valor. En el caso guatemalteco, el papel moneda permite observar transformaciones económicas, institucionales, políticas, artísticas y culturales. Por ello, un billete no debe reducirse a su denominación ni a su precio de colección: es también un documento material producido en un momento histórico determinado (Pérez Irungaray, 2025, 2026).

Para comenzar a estudiarlo conviene formular preguntas básicas: **¿quién lo emitió?, ¿cuándo?, ¿qué denominación tiene?, ¿quién lo imprimió?, ¿qué diseño utiliza?, ¿qué firmas o intervenciones presenta?, ¿circuló realmente?**
` }],
  },
  {
    titulo: "2. Papel moneda, respaldo y confianza: una precisión necesaria",
    bloques: [{ tipo: "texto", contenido: `
El borrador original contrapone moneda metálica con “valor intrínseco” y papel moneda fiduciario. Esa comparación requiere cautela. No toda moneda metálica vale únicamente por el metal que contiene y no todo billete histórico funcionó desde el inicio como dinero fiduciario moderno sin relación con reservas o convertibilidad.

En Guatemala, distintas etapas del papel moneda estuvieron relacionadas con promesas de pago, reservas metálicas, disposiciones legales, curso forzoso y posteriormente con sistemas de emisión centralizada. La **confianza** es importante, pero no sustituye el análisis de las condiciones jurídicas y económicas concretas de cada emisión.

Por ello:

**soporte físico ≠ fuente única del valor**  
**valor nominal ≠ valor del material**  
**aceptación jurídica ≠ confianza económica**

Estas distinciones permiten evitar explicaciones demasiado simples sobre la naturaleza del billete.
` }],
  },
  {
    titulo: "3. 1874: comienzo documentado de la emisión bancaria guatemalteca",
    bloques: [{ tipo: "texto", contenido: `
El **Banco Nacional de Guatemala** inició en 1874 la primera emisión oficial de papel moneda bancario documentada en Guatemala. La serie comprendió billetes de **1, 5, 10, 20, 50 y 100 pesos**, impresos en Estados Unidos por la **American Bank Note Company** (Banco de Guatemala, 2012; Pérez Irungaray, 2025, 2026; Quisquinay Rojas, 2022).

Esta precisión corrige dos errores frecuentes: no corresponde incluir 25 pesos dentro de aquella primera serie y la casa impresora no debe confundirse con la institución emisora.

**Banco Nacional de Guatemala → emisor**  
**American Bank Note Company → fabricante o casa impresora**

El billete de cinco pesos de 1874, por ejemplo, es simultáneamente una pieza monetaria, un producto de tecnología gráfica extranjera y un documento del primer experimento bancario nacional.
` }],
  },
  {
    titulo: "4. Tesorería Nacional: continuidad material y cambio institucional",
    bloques: [{ tipo: "texto", contenido: `
La liquidación del Banco Nacional en 1876 no significa que toda su historia material desapareciera inmediatamente. La bibliografía notafílica estudia conjuntamente al Banco Nacional y a la **Tesorería Nacional de Guatemala** porque existen piezas cuya trayectoria permite observar cambios de autoridad e intervenciones posteriores (Pérez Irungaray, 2025).

Este tipo de evidencia introduce una regla esencial para el análisis:

**diseño original ≠ necesariamente última etapa de uso de un billete.**

Sellos, contramarcas, registros u otras intervenciones pueden documentar que una pieza fue reutilizada, validada o administrada en un contexto institucional posterior. Por ello, nunca debe clasificarse un billete observando únicamente su impresión original.
` }],
  },
  {
    titulo: "5. La banca privada: diversidad de emisiones, no diversidad de monedas",
    bloques: [{ tipo: "texto", contenido: `
Entre finales del siglo XIX y la reforma monetaria del siglo XX, los bancos privados guatemaltecos produjeron una notable diversidad de billetes. Banco Internacional, Banco Colombiano, Banco de Occidente, Banco Americano, Banco Agrícola Hipotecario, Banco de Guatemala, S. A., y Banco Comercial forman parte de este universo de emisiones estudiado por la bibliografía especializada (Molina Calderón, 2008; Pérez Irungaray, 2025).

Para el notafílico, esta etapa es especialmente rica porque una misma unidad monetaria podía aparecer en piezas muy distintas según emisor, denominación, diseño, fecha, impresor, firmas e intervenciones.

Sin embargo, debe evitarse una conclusión equivocada:

**muchos emisores ≠ muchas unidades monetarias.**

La diversidad estaba en los billetes y en las instituciones responsables de emitirlos, no en que cada banco hubiera creado una moneda nacional diferente.
` }],
  },
  {
    titulo: "6. Las denominaciones deben documentarse, no suponerse",
    bloques: [{ tipo: "texto", contenido: `
Las denominaciones son una variable fundamental para reconstruir una serie, pero no deben explicarse mediante reglas económicas automáticas. Una denominación pequeña puede responder a necesidades de circulación fraccionaria; una alta puede relacionarse con operaciones de mayor valor, pero para interpretar su aparición deben examinarse las condiciones concretas de cada época.

La documentación guatemalteca muestra denominaciones poco comunes. Un ejemplo destacado es el **billete de 25 centavos del Banco de Occidente**, cuya existencia recuerda que las fracciones también forman parte de la historia del papel moneda (Pérez Irungaray, 2025, 2026).

Debe escribirse correctamente **25 centavos o 50 centavos**, no “0.25 centavos” cuando se pretende expresar un cuarto de la unidad monetaria.

Para el investigador:

**denominación observada → dato**  
**razón económica atribuida a esa denominación → interpretación que necesita evidencia.**
` }],
  },
  {
    titulo: "7. La “Empapelada”: expansión, respaldo y pérdida de confianza",
    bloques: [{ tipo: "texto", contenido: `
La denominada **“Empapelada”**, situada en la literatura reciente entre aproximadamente **1920 y 1924**, se relaciona con una expansión de billetes sin suficiente respaldo metálico y con pérdida de confianza en el sistema, dentro de un contexto monetario y fiscal más amplio (Pérez Irungaray, 2026; Banco de Guatemala, 2012).

No debe explicarse como si hubiera sido simplemente “imprimir demasiado papel”. Para comprenderla hay que considerar la relación entre **emisión, respaldo, situación fiscal, tipo de cambio, regulación y confianza**.

Tampoco conviene convertirla en una fórmula económica universal según la cual toda expansión monetaria produce automáticamente el mismo resultado. Aquí se estudia un episodio histórico concreto de Guatemala.
` }],
  },
  {
    titulo: "8. Del peso al quetzal: el billete no cambió el mismo día que la ley",
    bloques: [{ tipo: "texto", contenido: `
El quetzal fue creado legalmente el **26 de noviembre de 1924**, pero el primer billete denominado en quetzales fue emitido posteriormente por el Banco Central de Guatemala. *Un quetzal, una moneda, un siglo* identifica **1927** como el inicio de la emisión de billetes del quetzal (Banco de Guatemala, 2024).

Esta cronología permite aplicar al papel moneda una distinción ya estudiada:

**1924 → creación legal de la unidad monetaria**  
**1925 → primeras monedas del quetzal**  
**1926 → establecimiento del Banco Central de Guatemala, S. A.**  
**1927 → primeros billetes del quetzal**

Por tanto, una reforma monetaria no sustituye instantáneamente todas las piezas materiales del sistema anterior.
` }],
  },
  {
    titulo: "9. Los “Chemas”: retrato, diseño y memoria política",
    bloques: [{ tipo: "texto", contenido: `
Los primeros billetes del quetzal emitidos por el Banco Central incorporaron el retrato del general **José María Orellana**. En el ámbito numismático estas emisiones son conocidas como **“Chemas”**. Fueron producidas por casas impresoras inglesas, entre ellas Thomas de la Rue y Waterlow & Sons (Banco de Guatemala, 2024; Pérez Irungaray, 2025).

Su estudio permite comprender que la imagen de un billete no es simple decoración. Retratos, paisajes, escudos, quetzales, edificios y alegorías forman un programa visual que puede relacionarse con memoria histórica, legitimación institucional e identidad.

Sin embargo, el análisis iconográfico debe partir de evidencia: reconocer un personaje es distinto de afirmar, sin documentación, cuál fue la intención política exacta de quienes aprobaron el diseño.
` }],
  },
  {
    titulo: "10. De los “Chemas” a nuevos diseños del Banco Central",
    bloques: [{ tipo: "texto", contenido: `
Durante la etapa del Banco Central los diseños evolucionaron. La clasificación de Pérez Irungaray documenta, por ejemplo, que en el billete de **10 quetzales** el Diseño 1 de 1929–1935 conserva el busto de José María Orellana, mientras que el Diseño 2, utilizado desde 1935, elimina ese busto y lo sustituye por **un paisaje y dos quetzales sobre pilares** (Pérez Irungaray, 2025).

Este cambio muestra por qué es preferible hablar de **transformación del programa visual** y no afirmar automáticamente que todo rediseño significa “eliminación del personalismo” o una determinada intención política.

El método correcto es:

**primero describir qué cambió → después investigar por qué cambió.**
` }],
  },
  {
    titulo: "11. Billete emitido, espécimen y prueba: no son equivalentes",
    bloques: [{ tipo: "texto", contenido: `
La existencia física de una pieza no demuestra por sí sola que haya circulado. La bibliografía documenta billetes de **100 quetzales del Banco Central** que no fueron puestos en circulación: una variante corresponde a un espécimen y otra a una prueba de cambio de color (Pérez Irungaray, 2025).

Por ello deben distinguirse conceptos como:

- **billete emitido y circulado**;
- **espécimen**, conservado como muestra o referencia;
- **prueba**, vinculada al proceso de preparación o evaluación de una emisión.

Para el notafílico, confundir estas categorías altera la historia de la pieza. Una prueba puede ser auténtica y numismáticamente importante sin haber funcionado nunca como dinero circulante.
` }],
  },
  {
    titulo: "12. 1946–1948: billetes con una segunda vida institucional",
    bloques: [{ tipo: "texto", contenido: `
El Banco de Guatemala inició operaciones en **1946**, pero sus primeros billetes propios fueron autorizados hasta el **15 de septiembre de 1948**. Durante la transición utilizó papel moneda del extinto Banco Central en denominaciones de **50 centavos, 1, 5 y 20 quetzales**, intervenido con el nombre **“BANCO DE GUATEMALA”** (Pérez Irungaray, 2025).

Este episodio es excepcionalmente útil para aprender a observar:

un billete puede haber sido **diseñado e impreso para una institución** y posteriormente **intervenido para servir bajo otra**.

La intervención no es una imperfección que deba ignorarse. Puede ser precisamente el dato histórico que explique la función posterior de la pieza.
` }],
  },
  {
    titulo: "13. Los primeros billetes propios del Banco de Guatemala",
    bloques: [{ tipo: "texto", contenido: `
Los primeros billetes propios del Banco de Guatemala fueron autorizados en 1948 en denominaciones de **50 centavos, 1, 5, 10, 20 y 100 quetzales** (Pérez Irungaray, 2025).

A partir de esta etapa se desarrolla una amplia diversidad de diseños y posteriormente nuevas denominaciones. El billete de **50 quetzales** apareció en 1967 y, mucho más tarde, el sistema incorporó el de **200 quetzales**.

La aparición de una denominación nueva debe estudiarse mediante su documentación legal, económica y material. No es metodológicamente correcto afirmar que toda denominación alta demuestra por sí sola inflación ni que toda nueva denominación responde a una única causa.
` }],
  },
  {
    titulo: "14. El billete como soporte artístico e iconográfico",
    bloques: [{ tipo: "texto", contenido: `
Los billetes del Banco Central y del Banco de Guatemala permiten estudiar estilos artísticos, grabadores, pinturas, fotografías y transformaciones de imágenes utilizadas como base para los diseños. *Un quetzal, una moneda, un siglo* dedica estudios específicos a los estilos artísticos de los billetes y a la iconografía de la era moderna (Banco de Guatemala, 2024).

Desde finales de la década de 1960 se impulsaron cambios que incorporaron de manera más sistemática **temas mayas, personajes históricos, monumentos, costumbres, paisajes y símbolos nacionales**.

Esto convierte al billete en una fuente visual. Pero debe mantenerse una diferencia:

**descripción iconográfica → qué aparece**  
**interpretación iconológica → qué significado histórico puede tener**

La segunda exige mayor investigación y argumentación.
` }],
  },
  {
    titulo: "15. Clasificar no es solamente identificar",
    bloques: [{ tipo: "texto", contenido: `
La investigación reciente sobre los billetes guatemaltecos propone una clasificación jerárquica que integra **régimen monetario, entidad emisora y características físico-diseñísticas**. El corpus estudiado comprende **299 billetes diferenciados entre 1874 y 2023** (Pérez Irungaray, 2026).

En este sistema aparecen niveles como **diseño, variante y subvariante**. Una diferencia visible no debe convertirse automáticamente en una nueva categoría.

Las firmas ofrecen un buen ejemplo: el cambio de las personas firmantes, si se conserva la misma cantidad y disposición, no necesariamente constituye una variante; cambios estructurales en cantidad o posición pueden adquirir otra relevancia clasificatoria.

Por ello:

**observar una diferencia ≠ clasificarla.**

Primero se documenta la diferencia; después se aplica de manera coherente el criterio del sistema utilizado.
` }],
  },
  {
    titulo: "16. Ficha mínima para analizar un billete",
    bloques: [{ tipo: "tabla", columnas: ["Dato", "Qué debe observar"], filas: [
      ["Emisor", "Institución responsable de la emisión o intervención posterior"],
      ["Denominación", "Valor nominal y unidad monetaria"],
      ["Fecha", "Fecha impresa, autorizada o documentada para la emisión"],
      ["Casa impresora", "Empresa responsable de fabricar físicamente el billete"],
      ["Anverso y reverso", "Composición general, personajes, paisajes, símbolos y textos"],
      ["Firmas", "Cantidad, posición y autoridades representadas"],
      ["Serie y numeración", "Identificadores y posibles cambios sistemáticos"],
      ["Intervenciones", "Sellos, contramarcas, registros, tachones u otras modificaciones"],
      ["Diseño / variante / subvariante", "Nivel clasificatorio según criterios documentados"],
      ["Estatus", "Circulado, espécimen, prueba u otra condición comprobada"],
      ["Conservación", "Estado físico, sin confundirlo con identidad o clasificación histórica"],
    ]}],
  },
  {
    titulo: "17. Conclusión: aprender a leer el billete",
    bloques: [{ tipo: "texto", contenido: `
La historia del papel moneda guatemalteco no puede reducirse a una sucesión de bancos ni a una lista de denominaciones. Cada billete combina **autoridad emisora, tecnología de impresión, diseño, contexto legal, circulación e iconografía**.

El objetivo de esta unidad es que usted deje de preguntar solamente “¿qué billete es?” y comience a formular preguntas más rigurosas:

**¿qué evidencia material contiene?, ¿qué institución explica su existencia?, ¿qué cambió respecto de otras emisiones?, ¿esa diferencia tiene valor clasificatorio?, ¿circuló realmente?, ¿qué puede afirmarse de su iconografía y qué requiere investigación adicional?**

Ese cambio de mirada transforma el coleccionismo descriptivo en estudio notafílico.
` }],
  },
  {
    titulo: "Referencias de la unidad 9",
    bloques: [{ tipo: "texto", contenido: `
