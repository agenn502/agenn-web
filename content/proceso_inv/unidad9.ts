export const TEORIA = [
  { titulo: "1. Investigar y escribir no son dos procesos separados", bloques: [{ tipo: "texto", contenido: `
Es frecuente imaginar la investigación como una secuencia lineal: primero se investiga y después se redacta. En la práctica, escribir también permite evaluar la investigación.

El proceso suele ser iterativo:

**preguntar → investigar → escribir → detectar vacíos → volver a las fuentes → corregir → argumentar → reescribir**

Al intentar redactar una afirmación como “esta moneda fue creada para…”, surge inmediatamente una pregunta metodológica: **¿qué evidencia permite conocer esa intención?**

Si la fuente consultada demuestra únicamente que la pieza fue autorizada, el problema no es solamente de estilo. La escritura ha revelado que la conclusión excede la evidencia.
...
Una prueba útil consiste en completar:

**Este trabajo sostiene que…**

La frase no tiene que aparecer literalmente en el manuscrito. Su función es obligar al autor a identificar la **tesis** que defenderá.

Debe distinguirse:

- **Tema:** asunto general estudiado.
- **Objetivo:** aquello que se propone examinar.
- **Pregunta:** problema que busca responder.
- **Tesis:** respuesta o interpretación que el trabajo defenderá mediante evidencia.

“Reforma monetaria de 1924” es un tema.  
“Analizar la reforma monetaria de 1924” es un objetivo.  
“¿Cómo se materializó la reforma?” es una pregunta.  
...
**tema → problema → pregunta → tesis → argumentos → conclusión**

La tesis no debe confundirse con una afirmación arbitraria. Es una respuesta provisional que el manuscrito deberá sostener.

Los **argumentos** son las razones mediante las cuales esa tesis se defiende. Cada argumento debe apoyarse en evidencia pertinente y explicar por qué dicha evidencia permite avanzar hacia la conclusión.

Un trabajo puede poseer abundante bibliografía y, sin embargo, carecer de argumento si las fuentes aparecen solamente como información sucesiva.

Al revisar el manuscrito conviene preguntar:

1. ¿Qué sostengo?
2. ¿Qué evidencia sostiene cada parte?
3. ¿Cómo explico la relación entre evidencia y conclusión?
...
Una arquitectura funcional puede contener:

**Introducción:** presenta problema, pregunta, delimitación, relevancia y orientación del argumento.

**Desarrollo:** expone y analiza las evidencias necesarias para responder la pregunta.

**Discusión:** relaciona los hallazgos, contrasta interpretaciones y explica su significado.

**Conclusión:** responde la pregunta, establece el aporte y reconoce límites.
...
Por ejemplo, si se sostiene que una reforma monetaria tuvo implementación gradual, deben presentarse evidencias que documenten etapas diferentes y explicar por qué esas evidencias permiten hablar de gradualidad.

El límite puede precisar qué aspecto no puede establecerse todavía.

No todos los párrafos deben seguir mecánicamente la misma fórmula. Sin embargo, al revisar un texto puede comprobarse:

- qué afirma el párrafo;
- qué evidencia utiliza;
- qué razonamiento conecta ambas;
...
**Información tomada de una fuente:** debe atribuirse.

**Interpretación de otro autor:** debe identificarse como interpretación ajena.

**Inferencia propia:** debe quedar claramente diferenciada de aquello que afirma la fuente.

**Resultado del análisis propio:** debe explicarse mediante el procedimiento y la evidencia utilizados.
...
Suponga que una fuente documenta:

- fecha de autorización;
- denominación;
- cantidad fabricada.

Si el investigador añade que la pieza “fue retirada rápidamente porque el público rechazó su peso”, esa última afirmación necesita evidencia propia.

La pregunta de control es:

**Si otro investigador abre la fuente citada, ¿encontrará realmente respaldo para lo que acabo de afirmar?**

Cuando la respuesta es no, existen varias opciones:

- localizar una fuente adecuada;
- reformular la afirmación;
- reducir su alcance;
- identificarla como hipótesis;
- eliminarla.
...
Una **paráfrasis** expresa mediante una redacción nueva una idea obtenida de otra fuente. Aunque cambien las palabras, la idea continúa requiriendo atribución.

Modificar vocabulario o alterar el orden de una oración no convierte automáticamente una idea ajena en propia.

En fuentes históricas debe distinguirse además entre:

**transcripción documental:** reproducción de aquello que el documento dice;

**interpretación:** explicación construida por el investigador sobre su significado.
...
En AGENN se utilizará **APA 7** como sistema general de referencias. Según el tipo de fuente, deberán registrarse los datos pertinentes: autor o institución, fecha, título, editorial o publicación, volumen, número, páginas, DOI, URL u otros identificadores.

Las fuentes históricas, legislación, archivos y materiales institucionales pueden requerir adaptaciones descriptivas para conservar la información necesaria para su localización.

Una referencia como “Banco de Guatemala” no identifica por sí sola una publicación concreta. Del mismo modo, “Internet” no constituye una fuente.
...
Cuando corresponda, una figura debe indicar:

- identificación de la pieza;
- aquello que se pretende mostrar;
- procedencia de la imagen;
- colección o repositorio;
- autor o fotógrafo, cuando sea pertinente;
- número de figura y fuente.

Debe distinguirse:

**fuente de la información ≠ fuente de la imagen**

Una pieza puede ser identificada mediante un catálogo, contextualizada mediante una investigación histórica y fotografiada en una colección particular. Esas procedencias cumplen funciones diferentes.

Las tablas elaboradas por el investigador también deben indicar el origen de los datos, por ejemplo:
...
Estos verbos y expresiones funcionan como **marcadores epistemológicos**.

Escribir “posiblemente” no convierte en válida una afirmación que carece de fundamento. Incluso una posibilidad debe ser compatible con la evidencia disponible y explicar por qué merece considerarse.
...
**Después de examinar la evidencia, ¿qué puede sostenerse ahora respecto de la pregunta planteada?**

Una buena conclusión:

- responde explícitamente la pregunta;
- sintetiza el argumento central;
- establece el aporte;
- expresa el grado de certeza;
- reconoce límites;
- puede señalar preguntas que permanecen abiertas.
...
Una lista de control AGENN puede incluir:

**Pregunta:** ¿está claramente formulada?  
**Tesis:** ¿puede expresarse en una frase?  
**Evidencia:** ¿cada afirmación importante tiene soporte?  
**Correspondencia:** ¿la fuente realmente sostiene lo afirmado?  
**Inferencias:** ¿se distingue qué dedujo el autor?  
**Contradicciones:** ¿se atendió la evidencia incómoda?  
**Certeza:** ¿el lenguaje corresponde a la fuerza de la evidencia?  
**Imágenes:** ¿tienen procedencia?  
**Referencias:** ¿las citas y la lista final corresponden entre sí?  
**Conclusión:** ¿responde la pregunta?
...
Otros investigadores podrán:

- comprobar documentos;
- cuestionar interpretaciones;
- encontrar nueva evidencia;
- corregir atribuciones;
- proponer hipótesis alternativas;
- ampliar el corpus.

Esta posibilidad no debilita el conocimiento académico. Constituye una de sus condiciones.

Los trabajos desarrollados durante el nivel Investigador que alcancen suficiente calidad podrán ser identificados por el Consejo Académico como **trabajos con potencial de publicación en Revista AGENN**.

Esto no significa publicación automática. Un manuscrito podrá requerir:
...
Identifique cada elemento mediante las categorías:

**HECHO / FUENTE / INFERENCIA / INTERPRETACIÓN / PROBLEMA**

Busque especialmente:

1. afirmaciones sin fuente;
2. fuentes que no sostienen exactamente lo afirmado;
3. inferencias presentadas como hechos;
4. citas innecesarias o mal ubicadas;
5. paráfrasis que requieren atribución;
6. relaciones causales no demostradas;
7. lenguaje de certeza desproporcionado.

Después **reescriba completamente el párrafo**, procurando conservar únicamente aquello que pueda sostenerse y haciendo visible el razonamiento.
` }] },
  { titulo: "Actividad complementaria 2: La prueba de trazabilidad", bloques: [{ tipo: "texto", contenido: `
Seleccione cinco afirmaciones relevantes de un trabajo académico propio.

Construya la siguiente matriz:

| Afirmación | Fuente | Ubicación exacta | ¿La sostiene? | Acción |
|---|---|---|---|---|

En **Ubicación exacta**, registre página, sección, artículo legal, figura, registro u otra referencia que permita volver al fundamento.

En **Acción**, utilice una de estas decisiones:
...
1. revisar y precisar el título;
2. formular claramente problema y pregunta;
3. establecer una tesis;
4. organizar el texto según la lógica del argumento;
5. verificar las afirmaciones relevantes;
6. auditar la correspondencia entre citas y afirmaciones;
7. distinguir aportes propios y ajenos;
8. incorporar figuras o tablas únicamente cuando aporten evidencia o claridad;
9. redactar una conclusión que responda la pregunta;
10. normalizar las referencias según APA 7;
11. incluir un resumen;
12. incluir palabras clave;
...
Como guía interna, el Consejo podrá considerar: problema y tesis (15 %), evidencia y fuentes (25 %), argumentación (25 %), trazabilidad de citas (15 %), estructura y claridad (10 %), y referencias, figuras y presentación (10 %).

La decisión podrá expresarse como **aprobado**, **correcciones requeridas** o, cuando corresponda, **trabajo con potencial de publicación**.
` }] },
  { titulo: "Referencias de la unidad 9", bloques: [{ tipo: "texto", contenido: `
