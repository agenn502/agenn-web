export const TEORIA = [
  { titulo: "1. Tener evidencia no significa todavía tener una explicación", bloques: [{ tipo: "texto", contenido: `
Una investigación puede reunir monedas, billetes, fichas, decretos, noticias, registros y bibliografía sin haber construido todavía una explicación histórica.

La evidencia adquiere sentido respecto de una pregunta. Una fecha, una cifra de acuñación o una disposición legal pueden ser decisivas para un problema e irrelevantes para otro.

El proceso puede representarse así:

**dato → evidencia → relación → argumento → interpretación**
...
**Hecho documentado:** afirmación directamente sustentada por una fuente.  
Ejemplo: un decreto autoriza determinada denominación.

**Evidencia:** ese hecho utilizado para responder una pregunta.  
Ejemplo: el decreto constituye evidencia de autorización legal.

**Inferencia:** conclusión razonada que supera la observación directa.  
Ejemplo: la coexistencia documentada de especies anteriores y nuevas sugiere una transición gradual.

**Interpretación:** explicación que integra diversas evidencias e inferencias.  
Ejemplo: una reforma monetaria se materializó mediante un proceso de transición y no mediante sustitución instantánea.
...
Si cambia un gobierno y también cambia el diseño de una moneda, pueden formularse preguntas sobre una posible relación. Sin embargo, para afirmar que el cambio político **causó** el nuevo diseño debe localizarse evidencia que conecte ambos fenómenos.

Lo mismo ocurre con relaciones como:

- crisis económica y emisión;
- reforma monetaria y desaparición de una denominación;
- falsificación y nuevo elemento de seguridad;
- cambio político y nueva iconografía.
...
Pero una explicación plausible no es todavía una explicación demostrada.

Si una moneda incorpora determinado símbolo durante una coyuntura política, puede afirmarse que el símbolo aparece en la pieza y contextualizarse históricamente. Afirmar que fue incorporado **para simbolizar** aquella coyuntura requiere evidencia sobre la decisión o intención.

La investigación no premia la narración más atractiva, sino la explicación mejor sustentada.

Cuando la evidencia no permite determinar intención, una conclusión como:

**“no se ha localizado evidencia que permita establecer la intención de su incorporación”**
...
**¿Qué otra explicación podría producir la misma evidencia?**

Suponga que una denominación deja de aparecer en registros nuevos. Pueden proponerse varias hipótesis:

- dejó de circular;
- continuaron circulando ejemplares acuñados anteriormente;
- existe un vacío documental;
- otra especie asumió parte de su función;
- el corpus utilizado está incompleto.

El investigador debe buscar evidencia capaz de **discriminar entre hipótesis rivales**.

Esto evita el sesgo de confirmación: seleccionar únicamente aquello que favorece la explicación preferida.
...
Si tres catálogos y dos artículos derivan todos de una misma obra anterior, existe una **cadena de dependencia documental**. La cantidad de referencias es mayor que la cantidad de líneas independientes de evidencia.

En cambio, una disposición contemporánea, una pieza material, un registro administrativo y una noticia independiente que convergen hacia una misma conclusión pueden fortalecerla porque proceden de fuentes de naturaleza y origen diferentes.

Por ello:

**cantidad de citas ≠ cantidad de evidencia independiente**

El investigador deberá reconstruir, cuando sea posible, la genealogía de las afirmaciones y preguntar:

- ¿quién documentó primero el dato?;
- ¿qué fuente utilizó?;
- ¿los autores posteriores verificaron independientemente?;
...
**“No encontré monedas de ese año”** no equivale automáticamente a **“no se acuñaron monedas ese año”**.

Para evaluar una ausencia debe explicarse:

- qué corpus se examinó;
- qué archivos o registros se consultaron;
- qué tan completa es la serie;
- si razonablemente esperaríamos encontrar allí el dato;
- si existen pérdidas documentales conocidas;
- si otras fuentes pueden registrar el fenómeno.

Una formulación más rigurosa puede ser:

**“En los registros examinados no se localizó documentación de la emisión.”**
...
Tres fuentes dependientes pueden aportar menos que un documento directo. Diez fotografías pueden documentar diez ejemplares sin demostrar por qué se creó un diseño.
...
- independencia;
- coherencia entre evidencias;
- existencia de contradicciones;
- calidad y completitud del corpus;
- explicaciones alternativas.

Las afirmaciones extraordinariamente específicas requieren evidencia capaz de sostener ese grado de precisión.

Por ello el investigador debe preguntarse no solamente:
...
La contradicción puede revelar:

- error de fecha;
- diferencia regional;
- cambio dentro de un mismo año;
- distinción entre autorización y circulación;
- interés particular de una fuente;
- atribución catalográfica incorrecta;
- fenómeno más complejo de lo previsto.

La respuesta investigativa es:

**¿por qué estas evidencias no coinciden?**
...
Puede utilizarse una escala razonada:

**Demostrado:** existe evidencia directa y suficiente para la afirmación delimitada.

**Altamente probable o probable:** varias evidencias pertinentes convergen, aunque falta una confirmación directa o persisten vacíos menores.

**Posible:** la explicación es compatible con la evidencia, pero existen alternativas razonables.

**Hipótesis:** explicación propuesta que necesita comprobación adicional.

**No determinable con la evidencia disponible:** las fuentes conocidas no permiten decidir entre alternativas.
...
Una estructura útil para revisar la escritura es:

**afirmación + evidencia + razonamiento + límite**

Ejemplo:

**Afirmación:** la transición monetaria fue gradual.  
**Evidencia:** determinadas fuentes documentan nuevas especies mientras otras anteriores continúan presentes.  
**Razonamiento:** la coexistencia es compatible con una sustitución material no inmediata.  
**Límite:** la evidencia disponible no permite establecer con precisión cuánto tiempo circuló cada especie.
...
- responde una pregunta delimitada;
- utiliza evidencia pertinente;
- distingue observación e inferencia;
- identifica dependencia entre fuentes;
- considera evidencia contradictoria;
- compara hipótesis alternativas;
- expresa grados de certeza;
- reconoce límites;
- puede modificarse ante nueva evidencia.
...
- una fuente normativa o institucional;
- una pieza o evidencia material;
- una fuente contemporánea al fenómeno, cuando sea posible;
- una fuente secundaria;
- una evidencia que contradiga o complique parcialmente la explicación inicial.

Formule tres conclusiones:

**A.** una conclusión demasiado categórica;  
**B.** una conclusión proporcional a la evidencia;  
**C.** una conclusión excesivamente tímida que no aproveche evidencia disponible.

Después explique:

1. cuál está mejor sustentada;
2. qué evidencia sostiene cada afirmación;
3. dónde existen inferencias;
4. qué afirmaciones exceden la evidencia;
5. cómo afecta la fuente contradictoria;
6. qué nueva evidencia buscaría.

Finalmente redacte **su propia conclusión**, indicando explícitamente su grado de certeza.
` }] },
  { titulo: "Trabajo escrito de la unidad 8 — Interpretaciones en competencia", bloques: [{ tipo: "texto", contenido: `
Elabore un **ensayo académico de 2,000 a 3,000 palabras** sobre un problema numismático, notafílico o exonúmico guatemalteco para el cual puedan formularse al menos dos interpretaciones razonables.

El trabajo deberá:

1. formular y delimitar el problema;
2. plantear la pregunta de investigación;
3. presentar el corpus de evidencia;
4. identificar procedencia y posible dependencia de las fuentes;
5. formular al menos **dos hipótesis rivales**;
6. explicar qué evidencia favorece o debilita cada una;
7. incorporar evidencia contradictoria cuando exista;
8. evaluar explicaciones alternativas;
9. defender la interpretación que considere mejor sustentada;
10. asignar y justificar un grado de certeza;
11. identificar qué evidencia podría modificar la conclusión;
12. establecer qué aspectos continúan sin poder determinarse;
13. incluir referencias en formato APA.

El Consejo Académico no evaluará si el estudiante encontró una respuesta espectacular, sino **la calidad del razonamiento mediante el cual pasa de la evidencia a una conclusión**.

Una conclusión provisional, probable o incluso no determinable puede ser excelente si refleja correctamente el estado de la evidencia.
` }] },
  { titulo: "Referencias de la unidad 8", bloques: [{ tipo: "texto", contenido: `
