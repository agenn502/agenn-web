...
“Las monedas de Rafael Carrera”, “los billetes del Banco de Guatemala” o “las fichas de finca” pueden ser áreas de interés, pero deben convertirse en problemas concretos.

Un problema investigable puede surgir de:

- una contradicción entre fuentes;
- una cronología incierta;
- una atribución no demostrada;
- una clasificación discutible;
- una emisión poco documentada;
- una afirmación repetida sin evidencia suficiente;
- una transformación monetaria insuficientemente estudiada;
- una pieza cuyo contexto todavía no se conoce;
- una ausencia significativa;
- fuentes que no coinciden entre sí.

La pregunta fundamental es:

**¿Qué falta realmente por conocer?**
...
**Delimitación:** ¿el problema está acotado por período, objeto, institución, territorio o fenómeno?

**Evidencia:** ¿puede responderse mediante fuentes y no únicamente mediante opinión?

**Accesibilidad:** ¿existen fuentes que razonablemente pueda localizar dentro del tiempo y recursos disponibles?
...
5. justificación;
6. delimitación temporal, material, institucional o geográfica;
7. hipótesis inicial, cuando corresponda;
8. corpus previsto;
9. fuentes ya conocidas;
10. fuentes que todavía necesita localizar;
...
Dependiendo del problema, podrá incluir:
...
Para cada fuente deberá registrar:

**qué es → de dónde procede → qué aporta → qué limitaciones posee → qué afirmación puede sostener**

No todas las fuentes tendrán el mismo peso ni cumplirán la misma función.
...
Se recomienda llevar una **bitácora de búsqueda** con información como:

| Fecha | Fuente o repositorio | Búsqueda realizada | Resultado | Decisión |
|---|---|---|---|---|

Registrar una búsqueda negativa puede ser útil para:

- evitar repetir trabajo;
- demostrar qué series o archivos fueron revisados;
- identificar vacíos;
- justificar límites;
...
Si una búsqueda no produjo resultados, la redacción debe reflejar exactamente su alcance:
...
Durante el proceso puede ser necesario modificar:

- hipótesis;
- delimitación;
- clasificación;
- estructura;
- incluso parcialmente la pregunta.

Esto es válido si el cambio se explica y responde a nueva evidencia.

Si una fuente sólida contradice el planteamiento inicial, la respuesta correcta no es ocultarla. Debe incorporarse y examinarse.
...
**¿Qué aporta este trabajo que no estaba disponible de esta manera antes?**

El aporte puede ser:

**Documental:** localizar o utilizar una fuente poco conocida.

**Catalográfico:** corregir, ampliar o refinar una clasificación.

**Cronológico:** precisar una secuencia o fecha.

**Interpretativo:** proponer una explicación mejor sustentada.

**Metodológico:** aplicar un método de análisis a un corpus diferente.

**Negativo:** demostrar que una afirmación repetida carece actualmente de evidencia suficiente.
...
- conclusión;
- referencias;
- figuras, tablas o anexos cuando aporten evidencia.
...
El estudiante deberá poder recorrer la cadena:

**afirmación → evidencia → fuente → ubicación concreta**

Si se trata de una inferencia propia, deberá poder mostrar:

**afirmación → evidencias utilizadas → razonamiento**

Si la afirmación no puede rastrearse hasta una fuente o un razonamiento explícito, deberá revisarse.

La trazabilidad permite distinguir entre:
...
**Correcciones requeridas:** existen aspectos subsanables antes de aprobar.

**Reformulación sustantiva:** el proyecto presenta problemas metodológicos que necesitan revisión profunda.

Adicionalmente, el Consejo podrá identificar:

**Trabajo con potencial de publicación**

Esto significa que el manuscrito puede iniciar un proceso editorial en Revista AGENN. No implica publicación automática.

Un trabajo con potencial de publicación todavía podrá requerir:
...
- utilizar objetos como evidencia;
- delimitar corpus;
- clasificar cuando sea necesario;
- contrastar documentos;
- construir argumentos;
- diferenciar certeza, inferencia e hipótesis;
- reconocer límites;
...
La acreditación como Investigador no implica ascenso automático al nivel Numerario. El nivel **NUM** conserva sus propios requisitos y mecanismos de incorporación.

La diferencia esencial entre NOV e INV puede expresarse así:
...
3. ¿Cuál es mi pregunta?
4. ¿Qué evidencia podría responderla?
5. ¿Qué fuentes conozco?
6. ¿Qué fuente primaria debería intentar localizar?
7. ¿Qué explicación alternativa podría existir?
8. ¿Qué hallazgo me haría cambiar de hipótesis?
9. ¿Qué limitaciones puedo prever?
10. ¿Qué podría aportar realmente mi investigación?
