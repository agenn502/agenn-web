...
La semejanza formal no determina la naturaleza del objeto:

**objeto redondo + metal + cifra ≠ moneda**
...
Dentro de este universo pueden encontrarse fichas particulares, fichas de juego, jetones, medallas y otros objetos privados o conmemorativos. Sin embargo, compartir una categoría exonúmica no significa compartir función.

Una ficha puede aportar evidencia sobre relaciones laborales, producción agrícola, comercio, transporte, servicios, establecimientos, tecnología de fabricación y formas privadas de representar valor.

Por ello, la pregunta del investigador no debe detenerse en:
...
Morales Osterberg documenta piezas relacionadas con fincas, comercios, hoteles, transporte y servicios. Sus inscripciones podían expresar reales, centavos y quetzales, pero también:
...
- sacos;
- guacales;
- productos, alimentos, bebidas, pasajes y servicios.

Por ello, una cifra grabada puede representar dinero, producción, tiempo de trabajo o una unidad interna de cuenta (Morales Osterberg, 2026).

Ante una pieza marcada simplemente con “1”, la pregunta correcta es:
...
Pero esas características no demuestran por sí solas:

- quién la utilizó;
- durante qué período exacto;
- cómo se entregaba;
- cómo se redimía;
- qué representaba una cifra;
- si se aceptaba en un comisariato;
- si se aceptaba fuera del establecimiento;
- qué relación laboral existía entre emisor y usuario.

Morales Osterberg insiste en que para responder estas preguntas debe **salirse de la colección y entrar al archivo** (Morales Osterberg, 2026).
...
La atribución deberá sostenerse mediante correspondencias geográficas, cronológicas, personales o documentales.
...
El material puede aportar información tecnológica y orientar hipótesis cronológicas, pero **no fecha automáticamente una pieza**.

La fabricación ofrece otro caso metodológico importante. En **1894** se autorizó a la Casa de Moneda de Guatemala a fabricar moneda o piezas particulares bajo reglas determinadas. Esa intervención estatal reguló la fabricación, pero **no convirtió las fichas en moneda de curso legal** (Morales Osterberg, 2026).
...
La evidencia revisada por Morales Osterberg permite documentar el uso de fichas dentro de unidades productivas y en **comisariatos o tiendas internas**, pero advierte que las afirmaciones sobre aceptación habitual en poblaciones o establecimientos externos deben probarse para cada caso y no extenderse automáticamente a todo el sistema (Morales Osterberg, 2026).

También deben evaluarse críticamente testimonios de propietarios o actores interesados en defender el sistema. Una fuente interesada no es inútil, pero su posición forma parte de la evidencia que debe analizarse.
...
El **Decreto Gubernativo 879 del 26 de noviembre de 1924**, posteriormente aprobado y modificado por el **Decreto Legislativo 1379 del 2 de mayo de 1925**, prohibió el empleo de fichas, tarjetas, planchuelas u otros objetos de cualquier material en sustitución de la moneda legal (Morales Osterberg, 2026).

Pero prohibición no significa desaparición física.

Morales Osterberg documenta que en fincas continuaron utilizándose fichas como contraseñas para el control del trabajo. En el sistema denominado **“rayado”**, podían entregarse por tareas realizadas y devolverse para registrar en una tarjeta los jornales que debían pagarse posteriormente en moneda de curso legal.

La pieza ya no sustituía necesariamente el salario: podía **registrar el trabajo que debía remunerarse**.

Así:

**mismo tipo de objeto ≠ misma función histórica**
...
Puede representar año de fabricación, fundación del establecimiento, emisión, conmemoración, referencia histórica o una incorporación posterior.

Por ello:

**fecha inscrita ≠ fecha de fabricación necesariamente**
...
3. ¿los autores posteriores investigaron independientemente o la repitieron?
...
Pero para el Investigador AGENN el catálogo puede ser un punto de partida:

**ficha → establecimiento → propietario → trabajadores → producción → sistema de registro o pago → legislación → contexto histórico**

Morales Osterberg señala que las fichas, observadas junto con archivos y contexto social, permiten estudiar historias económicas y laborales que no siempre aparecen con la misma claridad en las fuentes oficiales.
...
Construya una matriz con cuatro columnas:

| Observación directa | Inferencia posible | Evidencia necesaria | Lo que todavía no puede afirmarse |
|---|---|---|---|

Por ejemplo:

**Observación:** aparece “1 jornal”.  
**Inferencia:** podría registrar una unidad de trabajo.  
**Evidencia necesaria:** documentación laboral o contable del establecimiento.  
**No puede afirmarse:** que equivaliera automáticamente a una cantidad determinada de moneda.

Incluya al menos **cinco observaciones** y proponga **tres rutas documentales** para continuar la investigación.

La actividad es formativa. No se evalúa quién adivina la función de la pieza, sino quién distingue mejor entre lo observado, lo inferido y lo que todavía necesita evidencia.
` }] },
  { titulo: "Trabajo escrito de la unidad 6 — Biografía documental de una pieza exonúmica", bloques: [{ tipo: "texto", contenido: `
Elabore una **biografía documental de una pieza exonúmica guatemalteca de 1,000 a 1,500 palabras**.

El trabajo deberá:

1. identificar y describir la pieza;
2. registrar su procedencia o la fuente de la imagen;
3. separar observación e interpretación;
4. identificar establecimiento, persona o institución relacionada, si la evidencia lo permite;
5. localizar al menos **tres fuentes adicionales**;
6. establecer qué función puede demostrarse;
7. distinguir función monetaria, laboral, administrativa, comercial u otra;
8. analizar críticamente fechas y atribuciones;
9. reconstruir el contexto histórico pertinente;
10. identificar afirmaciones tradicionales que no pudieron comprobarse;
11. presentar una interpretación propia;
12. indicar explícitamente qué continúa sin poder determinarse;
13. incluir citas y referencias completas.

Una ficha de catálogo **no constituye por sí sola la investigación completa**. Debe existir un intento documentado de llevar el objeto hacia fuentes externas.

El Consejo Académico evaluará especialmente la correspondencia entre pieza, fuentes y afirmaciones, y valorará positivamente que el estudiante reconozca los límites de la evidencia.
` }] },
  { titulo: "Referencias de la unidad 6", bloques: [{ tipo: "texto", contenido: `
- Cambranes, J. C. (1996). *Café y campesinos: Los orígenes de la economía de plantación moderna en Guatemala*. Editorial Cultura.
- Du Teil, O., & Du Teil, X. (1866). Cultivo del cafeto y beneficio de su fruto. *Memorias de la Sociedad Económica de Guatemala, 1*(5), 91–99.
...
- Guatemala. (1924, 26 de noviembre). Decreto Gubernativo No. 879, Ley Monetaria de la República de Guatemala.
- Guatemala. (1925, 2 de mayo). Decreto Legislativo No. 1379, aprobación y modificación de la legislación monetaria.

**Nota metodológica:** las referencias históricas adicionales deberán seleccionarse según la pieza investigada. La bibliografía especializada sirve para orientar la búsqueda, pero una atribución concreta deberá sostenerse con evidencia pertinente al establecimiento, período y función estudiados.
` }] },
];
