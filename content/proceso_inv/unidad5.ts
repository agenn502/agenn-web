...
Para investigar un sistema monetario pueden relacionarse:

**unidad monetaria → denominaciones → fracciones y múltiplos → materiales → legislación → acuñación → emisión → circulación**

Rodríguez Orozco (2023/2024) propone estudiar precisamente cómo las especies monetarias se acomodan históricamente dentro de la evolución del sistema decimal guatemalteco.

La pregunta rectora de esta unidad será:
...
Su propuesta incorpora además conceptos propios para describir configuraciones que una simple lista cronológica no explica adecuadamente.

Entre ellos se encuentran:

- **cono monetario básico:** conjunto de especies que se repiten con mayor continuidad y frecuencia durante determinado período;
- **cono híbrido:** configuración en la que coinciden especies pertenecientes a sistemas o configuraciones diferentes;
- **cono paralelo:** especies monetarias extranjeras cuya circulación es legalizada junto con las nacionales durante cierto período.
...
**autorizar ≠ fabricar o acuñar ≠ emitir ≠ poner en circulación ≠ lograr permanencia**

Esta diferencia es fundamental para reconstruir un cono monetario.

Una denominación prevista jurídicamente no debe incorporarse automáticamente al conjunto materialmente documentado. De manera inversa, la presencia de una pieza permite demostrar existencia material, pero no necesariamente el alcance de su circulación.

Por ello pueden construirse reconstrucciones distintas:

- sistema legalmente autorizado;
- sistema materialmente acuñado;
- sistema documentado como emitido;
- sistema cuya circulación puede demostrarse.
...
Rodríguez Orozco dedica su investigación a la formación y transformación del subcono decimal y sitúa sus antecedentes iniciales en **1870–1871**, antes de seguir su evolución hasta 2023.

La pregunta investigativa es:

**¿Qué significa históricamente que un sistema monetario haya sido adoptado?**

Para responder no basta con localizar una disposición. Deben contrastarse legislación, denominaciones previstas, monedas efectivamente acuñadas y continuidad posterior.
...
Después de los primeros intentos decimales, la secuencia guatemalteca presenta períodos en los que la estructura esperada no se mantiene de manera continua. El estudio de Rodríguez Orozco analiza precisamente las transformaciones, ampliaciones, reducciones y sustituciones que afectan un cono monetario.

El autor distingue fenómenos como:

- **sustitución**;
- **adición o agregación**;
- **sustracción, reducción o contracción**;
- **actualización**.

Estas categorías permiten preguntar no solamente qué moneda apareció, sino **qué efecto produjo su aparición o desaparición dentro de la estructura**.

Además, desde 1874 aparece el papel moneda guatemalteco, de modo que el análisis histórico del circulante comienza a requerir atención tanto a moneda metálica como a otras especies monetarias.
...
Para el investigador, esto plantea varias preguntas:

- ¿qué denominaciones se documentan?
- ¿cuáles reaparecen o desaparecen?
- ¿qué especies extranjeras conviven con las nacionales?
- ¿qué cambios legales acompañan la configuración?
- ¿qué evidencia permite hablar de estabilidad?
...
El Banco de Guatemala identifica como hitos la creación de la Caja Reguladora en 1923, la creación del **quetzal como unidad monetaria el 26 de noviembre de 1924** y el establecimiento del Banco Central de Guatemala en 1926. La Ley Monetaria y de Conversión de 1925 desarrolló posteriormente el marco de la reforma (Banco de Guatemala, 2024).

La transformación material tampoco ocurrió en un solo instante. Se documentan monedas de la nueva unidad fechadas en 1925 y 1926, y en 1927 comenzó el uso de billetes expresados en quetzales.

Este caso permite distinguir:

**fecha de la reforma legal → producción de especies → emisión → incorporación al circulante**

Cambiar el nombre o la definición de la unidad no significa que todas las piezas anteriores desaparezcan el mismo día.
...
También define **cono paralelo** como el constituido por moneda extranjera legalizada para circular junto con la moneda nacional durante determinado período.

Esto permite abandonar una imagen excesivamente limpia de las reformas monetarias.

Después de una reforma pueden:

- continuar especies anteriores;
- incorporarse nuevas denominaciones gradualmente;
- faltar algunas denominaciones previstas;
- coexistir moneda extranjera y nacional;
- producirse traslapes entre configuraciones.
...
Una denominación puede surgir, permanecer durante un período, experimentar cambios de diseño o material, desaparecer, ser sustituida o reaparecer bajo nuevas condiciones.

Por ello, una fecha inscrita en una moneda no debe confundirse automáticamente con todos los demás momentos de su historia.

Conviene distinguir, cuando las fuentes lo permitan:

- fecha inscrita;
- fecha de acuñación o fabricación;
- fecha de autorización;
- fecha de emisión o puesta en circulación;
- período documentado de uso;
- fecha de retiro o sustitución.
...
| Denominación | Fecha | Material | Estado documentado |
|---|---|---|---|

Sin embargo, detrás de cada celda existe una afirmación que debe poder justificarse.

Reconstruir un cono monetario exige cruzar:

**legislación + piezas + registros de acuñación + fechas + circulación + bibliografía + contexto histórico**

El investigador deberá además declarar qué representa su reconstrucción: lo autorizado, lo producido, lo emitido, lo documentado en circulación o una combinación explícitamente razonada.
...
Construya una tabla que distinga:

1. unidad monetaria;
2. denominaciones legalmente autorizadas;
3. denominaciones documentadas materialmente;
4. denominaciones cuya emisión o circulación puede demostrarse;
5. especies anteriores que continúan presentes;
6. moneda extranjera documentada, si corresponde;
7. ausencias o vacíos;
8. tipo de transformación observada;
9. grado de certeza de cada afirmación;
10. evidencia que todavía sería necesario localizar.

Incluya deliberadamente al menos un caso en el que **autorización y existencia material no puedan tratarse como equivalentes**.

Finalice respondiendo:

**¿Qué representa exactamente el sistema que usted reconstruyó: el legalmente autorizado, el materialmente documentado o el efectivamente circulante?**
` }] },
  { titulo: "Trabajo escrito de la unidad 5", bloques: [{ tipo: "texto", contenido: `
Elabore un **análisis de una transformación del sistema monetario guatemalteco de 1,000 a 1,500 palabras**.

Seleccione un período o transformación concreta. Entre las posibilidades se encuentran los primeros intentos decimales, las configuraciones de finales del siglo XIX, la Reforma Monetaria de 1924–1927 o una transformación posterior del subcono.

El trabajo deberá incluir:

1. pregunta de investigación;
2. delimitación temporal;
3. legislación pertinente;
4. denominaciones autorizadas;
5. especies materialmente documentadas;
6. diferenciación entre autorización, acuñación, emisión y circulación cuando las fuentes lo permitan;
7. tabla, esquema o representación de la configuración;
8. continuidades, adiciones, sustituciones o reducciones;
9. posibles configuraciones híbridas o paralelas, si la evidencia las demuestra;
10. contradicciones y vacíos documentales;
11. interpretación propia;
12. afirmaciones que todavía no pueden demostrarse;
13. citas y referencias completas.

El Consejo Académico evaluará la **correspondencia entre evidencia y reconstrucción**, no la reproducción mecánica del esquema de un autor.

Los conceptos propuestos por Rodríguez Orozco pueden utilizarse como herramientas analíticas, pero deberán aplicarse de manera argumentada.
` }] },
  { titulo: "Referencias de la unidad 5", bloques: [{ tipo: "texto", contenido: `
- Banco de Guatemala. (2012). *Del jade al polímero*. Banco de Guatemala.
...
- Rodríguez Orozco, L. A. (2023/2024). *El sub cono monetario de monedas de sistema decimal en Guatemala (1870–2023): Su historia y sus transformaciones*. Colección Numismática de Guatemala, Serie Monedas del Sistema Decimal, Ediciones Creativas / EDICREA.
- Sandoval Abullarade, V. H. (s. f.). *Monedas de Guatemala*.

**Nota bibliográfica:** el ejemplar consultado presenta una discrepancia editorial entre la ficha bibliográfica que consigna 2023 y páginas preliminares que consignan Guatemala, 2024. Por ello, en esta unidad se conserva provisionalmente la forma **2023/2024** hasta establecer la referencia bibliográfica definitiva del ejemplar.

**Nota metodológica:** los conceptos de cono básico, híbrido y paralelo se presentan como categorías propuestas por Rodríguez Orozco y no como terminología universal de la disciplina.
` }] },
];
